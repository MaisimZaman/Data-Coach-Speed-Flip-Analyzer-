...
player = players[0]
player2 = players2[0]
player3_0 = players3[0]


build_training_dataframe(df, player, map_df, num=1)
build_training_dataframe(df2, player2, map_df, num=2, no_speed_flips=True)
build_training_dataframe(df3, player3_0, map_df2, num=3, multi_player=True)
